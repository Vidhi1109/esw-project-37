...
def get_plot_data():
    # code , result = get_data("http://esw-onem2m.iiit.ac.in:443/~/in-cse/in-name/Team-37/Node-1/Data/la")
    # print("HELOOOOO" + code)
    # key = 'VidhiMafia'
...
def data():
    ...
    decrypted_string = decrypted_string.reshape(-1, 1000)
    ...
    # decrypted_string = np.array(decrypted_string).reshape(-1,1000)
    ...
    print(ans)
    response = make_response(json.dumps(69696969))
    return response
